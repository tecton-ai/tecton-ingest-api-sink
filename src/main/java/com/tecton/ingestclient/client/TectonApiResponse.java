...
public class TectonApiResponse {
    ...
    /**
     * The metrics related to ingestion.
     */
    ...
    public static class IngestMetrics {
        ...
        /**
         * The metrics related to feature view ingestion.
         */
